...
export let UtilTableRuleTags = (rules: TagRules, defualt: TagRule = { value: '', text: '无数据', class: 'blue', color: '#FFF' }): TagRules => {
...
export let UtilTableRuleDots = (rules: DotRules, defualt: DotRule = { value: '', text: '无数据', class: 'blue', color: '#FFF' }): DotRules => {
    let tagRules = new Proxy(rules, {
...
export let UtilTableRuleText = (rules: object, defualt: string = '无匹配'): object => {
    let tagRules = new Proxy(rules, {
